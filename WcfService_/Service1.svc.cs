...
namespace WcfService_
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-VG73S1M;Initial Catalog=WcfService1;Persist Security Info=True;User ID=sa; Password=ainun12345;Pooling=False");
